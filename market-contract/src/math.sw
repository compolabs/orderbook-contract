...
pub fn attempt_trade(
    ...
    let (seller, buyer, mut seller_order_amount_decrease, mut seller_account_delta, mut buyer_order_amount_decrease, mut buyer_account_delta) = match alice.order_type {
    ...
    match seller.asset_type {
        AssetType::Base => {
            ...
            if seller.amount < buyer_buy_amount {
                ...
                buyer_account_delta = base_to_quote_amount(buyer_order_amount_decrease, base_asset_decimals, seller.price, price_decimals, quote_asset_decimals) * quote_asset_decimals.as_u64();
                ...
                buyer_account_delta = base_to_quote_amount(buyer_order_amount_decrease, base_asset_decimals, buyer.price, price_decimals, quote_asset_decimals) * quote_asset_decimals.as_u64();
            } else {
                seller_order_amount_decrease = buyer_buy_amount;
                buyer_order_amount_decrease = buyer_buy_amount;
                buyer_account_delta = base_to_quote_amount(buyer_order_amount_decrease, base_asset_decimals, buyer.price, price_decimals, quote_asset_decimals) * quote_asset_decimals.as_u64();
        ...
        AssetType::Quote => {
            ...
            if seller.amount < buyer_buy_amount {
                seller_order_amount_decrease = seller.amount;
                buyer_order_amount_decrease = seller.amount;
                buyer_account_delta = quote_to_base_amount(buyer_order_amount_decrease, base_asset_decimals, seller.price, price_decimals, quote_asset_decimals) * base_asset_decimals.as_u64();
            } else if buyer_buy_amount < seller.amount {
                seller_order_amount_decrease = buyer_buy_amount;
                buyer_order_amount_decrease = buyer_buy_amount;
                buyer_account_delta = quote_to_base_amount(buyer_order_amount_decrease, base_asset_decimals, buyer.price, price_decimals, quote_asset_decimals) * base_asset_decimals.as_u64();
            } else {
                seller_order_amount_decrease = buyer_buy_amount;
                buyer_order_amount_decrease = buyer_buy_amount;
                buyer_account_delta = quote_to_base_amount(buyer_order_amount_decrease, base_asset_decimals, buyer.price, price_decimals, quote_asset_decimals) * base_asset_decimals.as_u64();
    ...
    match alice.order_type {
        OrderType::Sell => Result::Ok((seller_order_amount_decrease, seller_account_delta, buyer_order_amount_decrease, buyer_account_delta)),
        OrderType::Buy => Result::Ok((buyer_order_amount_decrease, buyer_account_delta, seller_order_amount_decrease, seller_account_delta)),
    }
}
