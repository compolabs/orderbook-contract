...
#[derive(Args, Clone)]
#[command(about = "Upgrades the usdf/usdc market proxy to a network")]
pub(crate) struct UpgradeUsdfUsdcProxyCommand {}

impl UpgradeUsdfUsdcProxyCommand {
    pub(crate) async fn run(&self) -> anyhow::Result<()> {
        ...
        let contract_id_str = "0x59020aadb448c59b48136a3cef110f1ddd2865000146514924f19b83f061ceba";
