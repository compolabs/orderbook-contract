...
#[derive(Args, Clone)]
#[command(about = "Upgrades the weth/usdc market proxy to a network")]
pub(crate) struct UpgradeWethUsdcProxyCommand {}

impl UpgradeWethUsdcProxyCommand {
    pub(crate) async fn run(&self) -> anyhow::Result<()> {
        ...
        let contract_id_str = "0x0bef6eb3018d901818978175feccf650b65dee8e3a8f5b59e138bcf1cf1d0db9";
