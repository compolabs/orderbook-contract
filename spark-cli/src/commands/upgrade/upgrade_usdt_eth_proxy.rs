...
#[derive(Args, Clone)]
#[command(about = "Upgrades the usdt/eth market proxy to a network")]
pub(crate) struct UpgradeUsdtEthProxyCommand {}

impl UpgradeUsdtEthProxyCommand {
    pub(crate) async fn run(&self) -> anyhow::Result<()> {
        ...
        let contract_id_str = "0x979ea6b1e15c1ec8e79eb76b587af89dd2620b383082e9b2c16049b78e97e4e8";
