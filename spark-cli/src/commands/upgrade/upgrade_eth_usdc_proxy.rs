...
#[derive(Args, Clone)]
#[command(about = "Upgrades the eth/usdc market proxy to a network")]
pub(crate) struct UpgradeEthUsdcProxyCommand {}

impl UpgradeEthUsdcProxyCommand {
    pub(crate) async fn run(&self) -> anyhow::Result<()> {
        ...
        let contract_id_str = "0xfe2c524ad8e088f33d232a45dbea43e792861640b71aa1814b30506bf8430ee5";
