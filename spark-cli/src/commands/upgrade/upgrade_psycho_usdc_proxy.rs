...
#[derive(Args, Clone)]
#[command(about = "Upgrades the psycho/usdc market proxy to a network")]
pub(crate) struct UpgradePsychoUsdcProxyCommand {}

impl UpgradePsychoUsdcProxyCommand {
    pub(crate) async fn run(&self) -> anyhow::Result<()> {
        ...
        let contract_id_str = "0x2eece85eb7c8ec5fd95e639fd6bb7e9dd7103a99d7321521848da246ecef5270";
