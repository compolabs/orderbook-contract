...
#[derive(Args, Clone)]
#[command(about = "Upgrades the fuel/eth market proxy to a network")]
pub(crate) struct UpgradeFuelEthProxyCommand {}

impl UpgradeFuelEthProxyCommand {
    pub(crate) async fn run(&self) -> anyhow::Result<()> {
        ...
        let contract_id_str = "0x4391b39d9165917faffb9dcc69d19b6952a6ebf02db593747cf2f5d8298d28c7";
