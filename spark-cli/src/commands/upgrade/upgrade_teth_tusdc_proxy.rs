...
#[derive(Args, Clone)]
#[command(about = "Upgrades the teth/tusdc market proxy to a network")]
pub(crate) struct UpgradeTethTusdcProxyCommand {}

impl UpgradeTethTusdcProxyCommand {
    pub(crate) async fn run(&self) -> anyhow::Result<()> {
        ...
        let contract_id_str = "0x6eb7a35c43a8eae0a2aeaf8c68b7d2d1cc7d2481d97abb8f68e4fb3cbab86a2a";
