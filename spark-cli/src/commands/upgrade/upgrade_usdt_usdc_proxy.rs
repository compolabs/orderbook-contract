...
#[derive(Args, Clone)]
#[command(about = "Upgrades the usdt/usdc market proxy to a network")]
pub(crate) struct UpgradeUsdtUsdcProxyCommand {}

impl UpgradeUsdtUsdcProxyCommand {
    pub(crate) async fn run(&self) -> anyhow::Result<()> {
        ...
        let contract_id_str = "0xe4e4844f78e2e470b590d0c76ffc9f4422a87317377813a181a02c60a60bc774";
