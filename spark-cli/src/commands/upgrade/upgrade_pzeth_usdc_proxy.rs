...
#[derive(Args, Clone)]
#[command(about = "Upgrades the pzeth/usdc market proxy to a network")]
pub(crate) struct UpgradePzethUsdcProxyCommand {}

impl UpgradePzethUsdcProxyCommand {
    pub(crate) async fn run(&self) -> anyhow::Result<()> {
        ...
        let contract_id_str = "0x12f52412e0ef50d4e38e1d03fd80d0a88fbaa7253e47f0cc48ba4e3049bd9ce4";
