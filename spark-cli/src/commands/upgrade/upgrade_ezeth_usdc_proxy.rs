...
#[derive(Args, Clone)]
#[command(about = "Upgrades the ezeth/usdc market proxy to a network")]
pub(crate) struct UpgradeEzethUsdcProxyCommand {}

impl UpgradeEzethUsdcProxyCommand {
    pub(crate) async fn run(&self) -> anyhow::Result<()> {
        ...
        let contract_id_str = "0xe4f64c6a9facdce0c055ecade9379c8f425411ec3f9523a472d14ce8a4fbce38";
